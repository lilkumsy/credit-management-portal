					...
					<div class="auth-form-container text-start mx-auto">
						<form class="auth-form auth-signup-form" action='' method="post" enctype="multipart/form-data">         
							...
							<div class="password mb-3">
								<label class="sr-only" for="signup-password">Email</label>
							...
							<div class="email mb-3">
								<label class="sr-only" for="signup-email">BVN</label>
								<input id="signup-email" name="signup-email" type="email" class="form-control signup-email" placeholder="Email" required="required">
							</div>
							<div class="password mb-3">
								<label class="sr-only" for="signup-password">Permanent Address</label>
								<input id="signup-password" name="signup-password" type="password" class="form-control signup-password" placeholder="Create a password" required="required">
							</div>
							<div class="email mb-3">
								<label class="sr-only" for="signup-email">Upload Passport</label>
								<input id="file" name="file" type="file" class="form-control signup-email" placeholder="Email" required="required">
							</div>
